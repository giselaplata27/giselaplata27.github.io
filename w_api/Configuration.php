...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '5526a6edff8070633e907dac8d6dfb25150469dd7dd3531ad312a0e740fcdaa0';
	const ERROR_REPORTING_LEVEL = 0;
	const DEPLOYED_HOSTNAME = 'ladder.com.mx';
	const BUILDDATE = 1503080783;
